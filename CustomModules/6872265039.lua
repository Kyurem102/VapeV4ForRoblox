        ...
        return setmetatable({}, {
            __index = function(obj, key)
                if _G.gc then
                    if targetKey then
                        for _, v in pairs(_G.gc) do
                            if type(v) == "table" and rawget(v, targetKey) ~= nil and (type(rawget(v, targetKey)) == "table" or type(rawget(v, targetKey)) == "function") then
                                return v
                            end
                        end
                    else
...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/Kyurem102/VapeV4ForRoblox/main/"..scripturl, true)
	end
end
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/Kyurem102/VapeV4ForRoblox/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
	...
	task.spawn(function()
		pcall(function()
			if not isfile("vape/Profiles/bedwarsdata.txt") then
				local commit = "main"
				for i,v in pairs(game:HttpGet("https://github.com/Kyurem102/VapeV4ForRoblox"):split("\n")) do
				...
				writefile("vape/Profiles/bedwarsdata.txt", game:HttpGet("https://raw.githubusercontent.com/Kyurem102/VapeV4ForRoblox/"..commit.."/CustomModules/bedwarsdata", true))
			end
			...
			repeat
				...
				local newdata = game:HttpGet("https://raw.githubusercontent.com/Kyurem102/VapeV4ForRoblox/"..commit.."/CustomModules/bedwarsdata", true)
